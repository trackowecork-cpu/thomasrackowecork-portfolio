...
solution:
  ...
  decisions:
    ...
    - n: "02"
      title: "Designing a scalable acquisition ecosystem"
      body: "The challenge extended far beyond redesigning individual product pages. The acquisition journey had evolved into a fragmented ecosystem, with inconsistent patterns, content structures, and interactions across both the upper funnel and checkout experience. We defined a unified design framework that connected discovery, consideration, and purchase into a coherent end-to-end journey. By simplifying content, removing underperforming elements, and introducing reusable patterns, we created a scalable system that could support future products, offers, and services while improving usability, consistency, and long-term maintainability across the entire funnel."
    - n: "03"
